...
function Program({
	...
	const InfoRow = ({ label, children }) => (
		<div className='flex mb-2'>
			...
			<div className='text-gray-500 w-[85%] sm:w-[88%] md:w-[90%]'>
				{children}
			</div>
		</div>
	);
		...
		<div className='font-sans p-[2%] md:mx-20'>
			<div className='flex flex-col sm:flex-row sm:space-x-4'>
				...
				<div className='sm:w-[75%] mt-[2%] sm:mt-[0%]'>
					<h1 className='font-bold text-red-900 text-xl w-[30%] sm:w-[35%] md:w-[20%]'>
						{title}
					</h1>
					<h1 className='text-red-600 text-xs w-[30%] sm:w-[35%] md:w-[20%]'>
						{e_title}
					</h1>
