...
function PurpleRewardCard() {
	return (
		<>
			<Card className='w-1/3'>
				<CardHeader className='flex gap-3'>
					<IconMedal2 className='w-14 h-14 mx-auto text-[#7b2cbf]' />
				</CardHeader>
				<Divider />
				<CardBody>
					<p className='text-center text-lg font-bold text-[#7b2cbf]'>
						紫紫會員
					</p>
				</CardBody>
				<Divider />
...
function GoldRewardCard() {
	return (
		<>
			<Card className='w-1/3'>
				<CardHeader className='flex gap-3'>
					<IconMedal2 className='w-14 h-14 mx-auto text-[#fad643]' />
				</CardHeader>
				<Divider />
				<CardBody>
					<p className='text-center text-lg font-bold text-[#fad643]'>
						金金會員
					</p>
				</CardBody>
				<Divider />
