            ...
            <div className="px-4 py-8">
                <div className="grid grid-cols-3  gap-8">
                    <div className="text-center">
                        ...
                        <ul>
                            <li><a href="#" className="hover:text-gray-300">票價說明</a></li>
                            <li><a href="#" className="hover:text-gray-300">最新消息</a></li>
                        </ul>
                    </div>

                    <div className="text-center">
                        <h3 className="text-lg font-semibold mb-4">會員資訊</h3>
                        <ul>
                            <li><a href="#" className="hover:text-gray-300">加入會員</a></li>
                            <li><a href="#" className="hover:text-gray-300">個人專區</a></li>
                        </ul>
                    </div>
