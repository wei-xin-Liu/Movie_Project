            ...
            <div className="mx-[2%] md:mx-[10%] mt-[2%]">
                <div className="flex">
                    <div>
                        ...
                        <div>
                            <div className="mb-2 text-sm">營業人名稱： 第一影城股份有限公司</div>
                            <div className="mb-2 text-sm">統一編號： 79846592</div>
                            <div className="mb-2 text-sm">地址：台中市東區南京路76號</div>
                            <div className="mb-2 text-sm">電話：(04)-3476-2366</div>
                            <div className="mb-4 text-sm">座位數：72席</div>
                    ...
                    <div className="">
                        <img className='w-[500px]' src="image/TheaterInfo/intro.jpg" alt="" />
                    </div>
                </div>
                <div className=''>
                    <h2 className="font-bold mt-[1%] mb-[3%] text-3xl text-[#0466c8]">交通位置</h2>
                    <div>
                        <div><h3 className="text-xl font-bold mb-[3%]">交通方式</h3></div>
                        <p className="text-base font-bold mb-2 ml-[2%]">【大眾運輸】</p>
                        <p className="text-sm ml-[4%] mb-2">◎ 搭乘火車或客運，至台中火車站下車，至火車站承租騎乘機車5分鐘，即可到達台中秀泰廣場站前店</p>
                        <p className="text-sm ml-[4%] mb-2">◎ 搭乘火車或客運，至台中火車站下車，沿著新民街步行，左轉復興路約10分鐘，即可到達台中秀泰廣場站前店</p>
                        <p className="text-sm ml-[4%] mb-2">◎ 搭乘高鐵，至台中高鐵站下車，轉搭33、158、166、6268、6670、6737號公車，45分鐘即可到達台中秀泰廣場站前店</p>
                        <br />
                        <p className="text-base font-bold mb-2 ml-[2%]">【自行開車】</p>
                        <p className="text-sm ml-[4%] mb-2">◎ 國道1號→大雅交流道下→經台74線往太原方向→右轉自由路4段→左轉南京路→台中秀泰廣場站前店</p>
                        <p className="text-sm ml-[4%] mb-2">◎ 國道3號→霧峰交流道下→經台74線往大里方向→左轉環中東路5段→旱溪西路1段→左轉振興路→右轉東光園路→左轉樂業南路→右轉建成路→左轉南京路→台中秀泰廣場站前店</p>
                        <p className="text-sm ml-[4%] mb-2">◎ 搭乘火車或客運，至台中火車站下車，搭乘11路公車(綠能街車)，即可到達台中秀泰廣場站前店</p>
                        <br />
                        <div className="text-base font-bold mb-2 ml-[2%]">【公車】</div>
                        <p className="text-sm ml-[4%] mb-[3%]">◎ 33、158、166、6268、6670、6737</p>
                    </div>
                    <div className='mb-[3%]'>
