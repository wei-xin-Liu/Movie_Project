			...
			<div className='content mt-[2%]'>
				<div className='container intro w-[80%] flex'>
					<div className='introText w-[70%] float-left'>
						<div>營業人名稱： 第一影城股份有限公司</div>
						<br />
						<div>統一編號： 79846592</div>
						<br />
						<div>地址：台中市東區南京路76號</div>
						<br />
						<div>電話：(04)-3476-2366</div>
						<br />
						<div>座位數：72席</div>
						<br />
						<div>
							...
							<br />
							配備Christie®Vive
							Audio陣列式喇叭。一體式弧線型陣列揚聲器的優勢在於能完整覆蓋全廳、提供最高的解析度、最真實的音質及高輸出的低頻效果。坐在影廳內的任何位置都能體會到這套設備所呈現的完美無瑕音場效果！
				...
				<div className='container loca w-[80%] block'>
					...
					<div>
						<h3 className='block text-[1.17em] my-[1em] font-bold'>交通方式</h3>
					</div>
					<p>【大眾運輸】</p>
					<br />
					<p>
						◎搭乘火車或客運，至台中火車站下車，至火車站承租騎乘機車5分鐘，即可到達台中秀泰廣場站前店
					</p>
					<br />
					<p>
						◎搭乘火車或客運，至台中火車站下車，沿著新民街步行，左轉復興路約10分鐘，即可到達台中秀泰廣場站前店
					</p>
					<br />
					<p>
						◎搭乘高鐵，至台中高鐵站下車，轉搭33、158、166、6268、6670、6737號公車，45分鐘即可到達台中秀泰廣場站前店
					</p>
					<br />
					<br />
					<p>【自行開車】</p>
					<br />
					<p>
						◎國道1號→大雅交流道下→經台74線往太原方向→右轉自由路4段→左轉南京路→台中秀泰廣場站前店
					</p>
					<br />
					<p>
						◎國道3號→霧峰交流道下→經台74線往大里方向→左轉環中東路5段→旱溪西路1段→左轉振興路→右轉東光園路→左轉樂業南路→右轉建成路→左轉南京路→台中秀泰廣場站前店
					</p>
					<br />
					<p>
						◎搭乘火車或客運，至台中火車站下車，搭乘11路公車(綠能街車)，即可到達台中秀泰廣場站前店
					</p>
					<br />
					<br />
					<div>公車</div>
					<br />
					<p>33、158、166、6268、6670、6737</p>
					<br />
					<div>
						<iframe
							src='https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7281.774924861999!2d120.68977200000002!3d24.14059!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34693d401a8fe027%3A0x9613bfdda28aa751!2zNDAx5Y-w54Gj5Y-w5Lit5biC5p2x5Y2A5Y2X5Lqs6LevNzbomZ8!5e0!3m2!1szh-TW!2sus!4v1721112469557!5m2!1szh-TW!2sus'
							width='100%'
							height='350'
							style={{ border: 0 }}
							allowFullScreen=''
				...
				<div className='container intro w-[80%] flex'>
					<table className='table-fixed w-[100%] text-center h-[200px]'>
						...
						<tbody>
							{tickets.map(
								({ TID, theaters, T_Adult, T_Stud, T_Early, T_Love }) => (
									<tr key={TID}>
